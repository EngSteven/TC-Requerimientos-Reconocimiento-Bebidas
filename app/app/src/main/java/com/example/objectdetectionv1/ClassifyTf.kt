...
import com.example.objectdetectionv1.MainActivity.Companion.INPUT_SIZE
import com.example.objectdetectionv1.ml.ModelUnquant2
...
class ClassifyTf(val context: Context) {
    val modelTfp = ModelUnquant2.newInstance(context)
